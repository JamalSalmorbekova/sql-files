...
select *
from cars
where brand NOT ILIKE 'TOYOTA';--14

select *
from cars order by price desc limit 10;--15


--Display the newest cars between 5th to 15th
...
select color, count(*) from cars group by color order by count(*) desc;--18
